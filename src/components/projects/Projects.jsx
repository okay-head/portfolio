...
export default function Projects() {
	return (
		<div className='projects bg-[var(--bg-purple2)]  py-[var(--p-section-y)]'>
			<Wrapper>
      <h1 className='text-5xl text-center mb-20'>Projects</h1>    
          ...
          <Card source={'./../../../src/assets/ableton-snapshot-home-IIII.png'} alt={'Ableton'} caption={'Ableton (responsive)'} cls={'row-span-2'} live_url={'https://okay-head.github.io/Ableton/'} code_url={'https://github.com/okay-head/Ableton'}/>
